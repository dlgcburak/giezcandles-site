...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  ...
  CREATE TABLE "products" (
  	...
  	"price_t_r_y" numeric DEFAULT 250 NOT NULL,
  	"description" varchar,
  	"image_id" integer,
  ...
  CREATE TABLE "site_settings" (
  	"id" serial PRIMARY KEY NOT NULL,
  	"hero_title" varchar DEFAULT 'Butik mumlar, sıcak bir his',
  	"hero_subtitle" varchar DEFAULT 'Giez Candle ile evine ve sevdiklerine küçük ama etkili bir dokunuş.',
  	"logo_id" integer,
  	"story_title" varchar DEFAULT 'Marka Hikayesi',
  	"story_text" varchar DEFAULT 'Giez Candle, el yapımı ve küçük partiler halinde üretilen butik mumlardan oluşur. Her tasarım, sıcak bir atmosfer ve özel bir hediye deneyimi hedefler.',
  	"whatsapp_number" varchar DEFAULT '+905346069871',
  	"etsy_url" varchar DEFAULT 'https://www.etsy.com/shop/GiezCandles?ref=shop_profile&listing_id=4431094665',
  	"shopier_url" varchar DEFAULT 'https://www.shopier.com/giezcandle',
  	"facebook_url" varchar DEFAULT 'https://www.facebook.com/giezcandlee/',
  	"instagram_url" varchar DEFAULT 'https://www.instagram.com/giezcandle/',
  ...
  CREATE INDEX "site_settings_hero_images_order_idx" ON "site_settings_hero_images" USING btree ("_order");
  CREATE INDEX "site_settings_hero_images_parent_id_idx" ON "site_settings_hero_images" USING btree ("_parent_id");
  CREATE INDEX "site_settings_hero_images_image_idx" ON "site_settings_hero_images" USING btree ("image_id");
